export const localizations = {
  ...
  deleteEntryOnKick_true: {
    ...
    ru: "Бот будет удалять сообщения о входе пользователей, проваливших капчу.",
    uk:
  ...
  deleteEntryOnKick_false: {
    ...
    ru:
      "Великолепно! Бот не будет удалять сообщения о входе пользователей, проваливших капчу.",
    uk:
  ...
  cas_true: {
    ...
    ru: "Великолепно! Бот теперь будет использовать Combot Anti-Spam.",
  ...
  cas_false: {
    ...
    ru: "Великолепно! Бот теперь не будет использовать Combot Anti-Spam.",
  ...
  underAttack_true: {
    ...
    ru:
      "Отлично! Бот теперь будет кикать всех, кто заходит в этот чат. Не забудьте отключить этот режим после окончания атаки при помощи команды /underAttack.",
    uk:
  ...
  underAttack_false: {
    ...
    ru: "Отлично! Бот теперь не будет кикать всех, кто заходит в этот чат.",
    uk:
  ...
  noAttack_true: {
    ...
    ru:
      "Отлично! Бот отключён. Не забудьте снова включить его командой /noAttack.",
    hu:
  ...
  noChannelLinks_true: {
    ...
    ru:
      "Отлично! Бот теперь будет удалять сообщения с ссылками на Телеграм-каналы.",
    es:
  ...
  noChannelLinks_false: {
    ...
    ru:
      "Отлично! Бот теперь не будет удалять сообщения с ссылками на Телеграм-каналы.",
    es:
  ...
  filters: {
    en:
      "Reply to this message (and I mean reply(!), not just send a separate message) with up to 10 links in format below to setup greeting buttons. Reply with anything else to remove all buttons.\n\nCurrent buttons:",
    ru:
      "Ответьте на это сообщение (и я имею ввиду ответьте(!), а не просто отправьте отдельное сообщение), чтобы добавить фильтры. Ответьте любым другим сообщением, чтобы удалить все фильтры.\n\nТекущие фильтры:",
  },
  filtersEmpty: {
    en: "No filters",
    ru: "Нет фильтров",
